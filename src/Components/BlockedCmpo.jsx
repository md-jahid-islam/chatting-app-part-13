...
const BlockedCompo = () => {
  ...
  return (
    <>
        <div className="max-w-3xl mx-auto p-4 scroll-px-24 scroll-py-24 mt-16 duration-300 h-[200px] rounded-md hover:scale-105 transition bg-[#4C3BCF]">
        <h1 className="text-3xl font-bold text-center mb-[10px] text-[#363636] mt-7">People you've blocked</h1>
        <h2 className='text-xl font-regular text-center mb-8 p-5 '>These people will not be able to connect with <br /> you unless you unblock them</h2>
        {
